...
def insert_data(cursor, data):
    insert_query = sql.SQL("""
        INSERT INTO carrefour.transp (
            ...
            endereco, municipio, cep, cnpj, ie, tipo_carga, vuc_plataforma, vuc, 
            leve_seco, leve_seco_plt, leve_refrigerado, toco_seco, toco_seco_plt, 
