...
#Criando a classe de conexão com 
...
#Criando a classe Person com herança da classe Connection e o insert
...
try:
    ...
    # sep='|' => Arquivos csv pode conter separadores como ';',',',' ', etc...
    # Este arquivo foi criado no DBeaver e foi informado o separador '|' porque tem campos
    # com ',' e ';' nos dados, o que geraria erro ao ler da forma abaixo no pandas.
...
##################################################
#Inserindo uma linha de dados via script
...
#Inserindo um dataframe não disponibilizado no github (contem dados reais de uma empresa) com 2.984.512 linhas de dados via script
